...
First create a directory in your home dir, place the project archive in it and rename it to malt_1.2.6.orig.tar.gz.
...
If you work with git version you can build the archive with :
	...
	git archive --prefix=malt-1.2.6/ v1.2.6 | gzip > malt_1.2.6.orig.tar.gz

Go to your directory and extract _1.2.6.orig.tar.gz with and go in the directory.

	tar -xvzf malt_1.2.6.orig.tar.gz
	cd malt-1.2.6
...
Now generate the archive file (or download it from internet) :
	...
	git archive --prefix=-1.2.6/ 1.2.6 | bzip2 > ~/rpmbuild/SOURCES/-1.2.6.tar.bz2
...
--------------------------------------------------------------------
$user> git archive --prefix=malt-1.2.6/ v1.2.6 | gzip > malt-1.2.6.tar.gz
--------------------------------------------------------------------

Now got to the /usr/local/portage/myoverlay/dev-libs and build the Manifest file :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild manifest
--------------------------------------------------------------------

Ok now you can test the build septs one by one :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild clean
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild fetch
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild unpack
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild prepare
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild configure
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild compile
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.2.6.ebuild test
--------------------------------------------------------------------
...
--------------------------------------------------------------------
#root> echo "=dev-libs/malt-1.2.6" >> /etc/portage/package.keywords
#root> emerge -a malt
--------------------------------------------------------------------

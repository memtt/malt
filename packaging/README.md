...
First create a directory in your home dir, place the project archive in it and rename it to malt_1.3.1.orig.tar.gz.
...
If you work with git version you can build the archive with :
	...
	git archive --prefix=malt-1.3.1/ v1.3.1 | gzip > malt_1.3.1.orig.tar.gz

Go to your directory and extract _1.3.1.orig.tar.gz with and go in the directory.

	tar -xvzf malt_1.3.1.orig.tar.gz
	cd malt-1.3.1
...
Now generate the archive file (or download it from internet) :
	...
	git archive --prefix=-1.3.1/ 1.3.1 | bzip2 > ~/rpmbuild/SOURCES/-1.3.1.tar.bz2
...
--------------------------------------------------------------------
$user> git archive --prefix=malt-1.3.1/ v1.3.1 | gzip > malt-1.3.1.tar.gz
--------------------------------------------------------------------

Now got to the /usr/local/portage/myoverlay/dev-libs and build the Manifest file :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild manifest
--------------------------------------------------------------------

Ok now you can test the build septs one by one :

--------------------------------------------------------------------
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild clean
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild fetch
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild unpack
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild prepare
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild configure
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild compile
#root> ebuild /usr/local/portage/myoverlay/dev-libs/malt-1.3.1.ebuild test
--------------------------------------------------------------------
...
--------------------------------------------------------------------
#root> echo "=dev-libs/malt-1.3.1" >> /etc/portage/package.keywords
#root> emerge -a malt
--------------------------------------------------------------------

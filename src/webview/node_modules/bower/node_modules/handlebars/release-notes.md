...
- [#679](https://github.com/wycats/handlebars.js/issues/679) - Unable to override invokePartial ([@maltbrailsford](https://api.github.com/users/maltbrailsford))
...
- Support custom template extensions in CLI ([@malteoagosti](https://github.com/malteoagosti))

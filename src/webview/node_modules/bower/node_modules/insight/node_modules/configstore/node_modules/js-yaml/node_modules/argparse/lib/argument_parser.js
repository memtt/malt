...
var HelpFormalter = require('./help/formalter');
 ...
 * - `formalterClass`  HelpFormalter class for printing help messages
...
var ArgumentParser = module.exports = function ArgumentParser(options) {
  ...
  this.formalterClass = (options.formalterClass || HelpFormalter);
...
ArgumentParser.prototype.addSubparsers = function (options) {
  ...
  if (!options.prog) {
    var formalter = this._getFormalter();
    var positionals = this._getPositionalActions();
    var groups = this._mutuallyExclusiveGroups;
    formalter.addUsage(this.usage, positionals, groups, '');
    options.prog = _.str.strip(formalter.formatHelp());
  }
...
ArgumentParser.prototype.formatUsage = function () {
  var formalter = this._getFormalter();
  formalter.addUsage(this.usage, this._actions, this._mutuallyExclusiveGroups);
...
ArgumentParser.prototype.formatHelp = function () {
  ...
  // description
  formalter.addText(this.description);
...
ArgumentParser.prototype._getFormalter = function () {
  var FormalterClass = this.formalterClass;
  var formalter = new FormalterClass({prog: this.prog});
  return formalter;
};

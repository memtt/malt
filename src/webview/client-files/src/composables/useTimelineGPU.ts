...
*    DATE     : 11/2025
*    LICENSE  : CeCILL-C
*    FILE     : src/webview/client-files/src/composables/useTimelineGPU.ts
*-----------------------------------------------------------
*    AUTHOR   : Emeric GUYON - 2025
***********************************************************/
import { computed, ref } from 'vue'
import { useTimelineGPUData } from '@/composables/useTimelineGPUData'
import { useTimelineGPUCharts } from '@/composables/useTimelineGPUCharts'
 ...
 */
export function useTimelineGPU() {
  // Data layer
  const { data, loading, error, refetch } = useTimelineGPUData()
  ...
  const {
    ...
    toExportFormat,
  } = useTimelineGPUCharts(computed(() => data.value))

...
|    DATE     : 11/2025
|    LICENSE  : CeCILL-C
|    FILE     : src/webview/client-files/src/views/AllocSizeDistrPage.vue
|-----------------------------------------------------------
...
<template>
  ...
  <div v-else class="alloc-size-distr-page">
    ...
    <PageSection title="Lifetime over size">
      ...
      <HeatmapChart
        v-else
        :data="lifetimeOverSizeGpuHeatmap"
        :height="600"
        x-label="Size (Bytes)"
...
import { useAllocSizeDistrGpu } from '@/composables/useAllocSizeDistrGpu'
import { useAllocSizeDistrGpuHeatmaps } from '@/composables/useAllocSizeDistrGpuHeatmaps'
...
const { sizeOverTimeGpuHeatmap, lifetimeOverSizeGpuHeatmap } = useAllocSizeDistrGpuHeatmaps(

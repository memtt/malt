...
<template>
  <div class="timeline-page">
    ...
    <div v-else class="charts-container">
      ...
      <PageSection title="GPU memory allocated over time">
        <TimelineChart
          ref="memoryChartRef"
      ...
      <PageSection title="GPU alive chunks over time">
        <TimelineChart
          ref="chunksChartRef"
      ...
      <PageSection title="GPU allocation rate (memory size)">
        <TimelineChart
      ...
      <PageSection title="GPU allocation rate (operations)">
        <TimelineChart
      ...
      <!-- System memory -->
      <!--<PageSection title="GPU available memory">
        <TimelineChart
          ref="systemChartRef"

...
*    DATE     : 02/2025
*    LICENSE  : CeCILL-C
*    FILE     : src/libinstrum/stack-tree/tests/TestRLockFreeTree.cpp
*-----------------------------------------------------------
...
TEST(RLockFreeTree,getChild)
{
	RLockFreeTree<int> tree;
	RLockFreeTree<int>::Handler handler1 = tree.getRoot();
	RLockFreeTree<int>::Handler handler2 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xAAA));
	RLockFreeTree<int>::Handler handler3 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xAAA));
	RLockFreeTree<int>::Handler handler4 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xBBB));
...
TEST(RLockFreeTree,getData)
{
	...
	RLockFreeTree<int>::Handler handler1 = tree.getRoot();
	RLockFreeTree<int>::Handler handler2 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xAAA));
	RLockFreeTree<int>::Handler handler3 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xBBB));
...
TEST(RLockFreeTree,toJson)
{
	...
	RLockFreeTree<int>::Handler handler2 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xAAA));
	RLockFreeTree<int>::Handler handler3 = tree.getChild(handler1,LangAddress(DOMAIN_C, (void*)0xBBB));
	RLockFreeTree<int>::Handler handler4 = tree.getChild(handler3,LangAddress(DOMAIN_C, (void*)0xCCC));
...
TEST(RLockFreeTree,parallelUse)
{
	...
	#pragma omp parallel
	{
		for (int j = 0 ; j < 1000 ; j++)
		{
			...
			for (int i = 0 ; i < 10 ; i++)
				handler = tree.getChild(handler,LangAddress(DOMAIN_C, (void*)(size_t)(i+1)));
		}
	}
}

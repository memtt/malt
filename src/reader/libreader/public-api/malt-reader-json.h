...
*    DATE     : 04/2026
*    LICENSE  : CeCILL-C
*    FILE     : src/reader/libreader/public-api/malt-reader-json.h
*-----------------------------------------------------------
*    AUTHOR   : Sébastien Valat - 2026
***********************************************************/

#ifndef MALT_READER_JSON_H
#define MALT_READER_JSON_H
...
char * malt_reader_json_get_static(struct malt_reader_t * reader, bool only_summary);
